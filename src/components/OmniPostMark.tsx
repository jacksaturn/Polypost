// OmniPost brand mark: a gradient rounded-square app icon with a white
// paper-plane ("send to everywhere"). Self-contained — owns its own background.
export function OmniPostMark({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 48 48" role="img" aria-hidden="true" focusable="false">
      <defs>
        <linearGradient id="omnipost-grad" x1="0" y1="0" x2="1" y2="1">
          <stop offset="0" stopColor="#6366f1" />
          <stop offset="1" stopColor="#0ea5e9" />
        </linearGradient>
      </defs>
      <rect width="48" height="48" rx="12" fill="url(#omnipost-grad)" />
